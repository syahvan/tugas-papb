...
class Info : Fragment() {
    ...
    override fun onCreateView(
        ...
        ghbtn.setOnClickListener() {val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/jjewuz/SoloWeather"))
            startActivity(i)}
        sitebtn.setOnClickListener() {val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://jjewuz.github.io/"))
            startActivity(i)}
        ratebtn.setOnClickListener() {val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.heron.soloweather"))
            startActivity(i)}
